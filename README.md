...
All these mirrors are generated by using some function Z = F(X,Y). Try if you can get all the F(X,Y) functions. Images used are [chess image](chess.png) and [face](img3.jpg)
